(() => {
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      .ddwa-card{position:relative;overflow:hidden;background:#159d98 url("assets/cartao-agradecimento.png?v=20260915-2") center/100% 100% no-repeat;font-family:Axiforma,Inter,Arial,sans-serif}
