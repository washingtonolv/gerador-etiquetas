(() => {
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      .ddwa-title{position:absolute;top:18.5%;left:9%;right:9%;text-align:center;color:#fff;font-family:Bochan,Georgia,serif;font-weight:500;font-size:clamp(17px,2.45vw,31px);line-height:1.06;text-shadow:0 1px 1px rgba(0,0,0,.03)}
      ...
      @media print{
        ...
        body.dd-whatsapp-print .ddwa-title{font-size:8.4mm!important}.ddwa-dynamic{font-size:4.1mm!important}.ddwa-social-copy{font-size:3.25mm!important}.ddwa-social{font-size:3.7mm!important}.ddwa-site{font-size:2.85mm!important}
      }
    `;
  ...
  function renderCard(card) {
    return `
      <article class="ddwa-card">
        ...
        <div class="ddwa-title">Obrigada por<br>comprar na<br>D&amp;D Cosméticos!</div>
